      ...
      var Intense = (function() {
          ...
          function createViewer( title, caption ) {
            ...
            var containerProperties = {
              ...
              'zIndex': '999999',
              'margin': '0px',
              'webkitTransition': 'opacity 500ms cubic-bezier( 0, 0, .26, 1 )',
              'MozTransition': 'opacity 500ms cubic-bezier( 0, 0, .26, 1 )',
              'transition': 'opacity 500ms cubic-bezier( 0, 0, .26, 1 )',
              'opacity': '0'
            };
